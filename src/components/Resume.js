...
const Resume = () => {
  ...
  return (
    <div className="resume">
      {/* About Me Section */}
      <div
        className="resume__section resume__section--top-left"
      ...
      {/* Experience Section */}
      <div
        className="resume__section resume__section--top-right"
      ...
      {/* Education Section */}
      <div
        className="resume__section resume__section--bottom-left"
      ...
      {/* Skills Section */}
      <div
        className="resume__section resume__section--bottom-right"
